...
| design/future | 设计目标，未实现，不得当现状引用 | specs/*、backlog.md、control-loop-roadmap.md、plugin-real-eval-runner.md（含 future 段）、dev-workflow-spec.md |
| historical/dated | 历史证据，只证明当时 | validation-log.md、python-rust-ownership.md、codex-cli-control.md、decision-logging 之外的 dated 材料 |
