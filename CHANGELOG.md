...
- **Verified**: all 5 plugins `validate` + static `eval` green; `test_plugins.py`, `test_agent_job_readonly.py` (12), `test_plugin_eval_run.py` (20 passed) all green; real `eval-run`: agy negative case ok (rejection message hit), dev-workflow 4-case A/B recorded under the run artifacts.
